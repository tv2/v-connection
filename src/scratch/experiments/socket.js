...
webby.on('message', m => { if (m.indexOf('/scheduler status') < 0) console.log('message1:', m) });
...
setTimeout(() => {
  socket.write('4 schedule {112}/storage/shows/{239F365A-5671-43F3-AD44-D44EB7C4F206}/elements/100_NYHEDERNE-TEST.SOFIE.VIZ-ELEMENTER_271DB363_0 {0} schedule 0 {0} profile /config/profiles/MOSART viz {5}Viz A command take show {62}/storage/shows/{239F365A-5671-43F3-AD44-D44EB7C4F206}/elements \n\n')
