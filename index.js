...
let state = 'STATE_<entry name="LOWER">\n' +
...
setTimeout(() => {
  webby.send('2 set attribute {67}/storage/shows/{3CA3F632-A13D-4F33-B57F-953850BDF6BB}/elements/2481 take_count 57\n\n')
  webby.send(`3 set text /scheduler/localhost/state/background/TV2/PILOT_TEMPLATES/2015_DESIGN/NYHEDERNE/overlays/MASTER/LOWER/current {${state.length}}${state}\n\n`);
  webby.send(`4 set text /scheduler/localhost/state/background/TV2/PILOT_TEMPLATES/2015_DESIGN/NYHEDERNE/overlays/MASTER/LOWER/state/current NAME\n\n`);
}, 5000)
